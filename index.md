...
<head>
  ...
  <link rel="canonical" href="https://backbonejs.org" />
...
<body>
  ...
  <div id="sidebar" class="interface">
    ...
    <ul class="toc_section">
      <li>&raquo; <a href="https://github.com/jashkenas/backbone">GitHub Repository</a></li>
  ...
  <div class="container">
    ...
    <p>
      The project is <a href="https://github.com/jashkenas/backbone/">hosted on GitHub</a>,
      ...
      Backbone is available for use under the <a href="https://github.com/jashkenas/backbone/blob/master/LICENSE">MIT software license</a>.
    </p>

    <p>
      You can report bugs and discuss features on the
      <a href="https://github.com/jashkenas/backbone/issues">GitHub issues page</a>,
    ...
    <p>
      <i>
        ...
        <a href="https://documentcloud.org/">DocumentCloud</a>.
      </i>
    </p>
...
<pre>var Books = Backbone.Collection.extend({
  ...
  parse: function(data) {
    ...
    <p>
      ...
      <a href="https://facebook.github.io/react/docs/tutorial.html">React virtual DOM</a>.
...
<pre>class Country extends Backbone.Model {
...
alert(JSON.stringify(artist));
    ...
    <p id="Model-fetch">
      ...
      <a href="https://api.jquery.com/jQuery.ajax/#jqXHR">jqXHR</a>.
...
setInterval(function() {
  channel.fetch();
    ...
    <p id="Model-save">
      ...
      <a href="https://api.jquery.com/jQuery.ajax/#jqXHR">jqXHR</a> if
...
<pre>book.save("author", "F.D.R.", {error: function(){ ... }});
    ...
    <p id="Model-destroy">
      ...
      <a href="https://api.jquery.com/jQuery.ajax/#jqXHR">jqXHR</a> object, or
...
<pre>class Library extends Backbone.Collection {
  preinitialize() {
...
<pre>class Router extends Backbone.Router {
  preinitialize() {
...
<pre>$(function(){
  ...
  Backbone.history.start({pushState: true});
    ...
    <p>
      ...
      <a href="https://api.jquery.com/jQuery.ajax/#jqXHR">jqXHR</a>. You can override
...
<pre>def update
  ...
  render :json => account
    ...
    <p id="Sync-ajax">
      ...
      the <a href="https://api.jquery.com/jQuery.ajax/">jQuery.ajax</a> API
...
<pre>class Document extends Backbone.View {
...
<pre>var Bookmark = Backbone.View.extend({
  ...
  render: function() {
    ...
    <p>
      ...
      <a href="https://github.com/sstephenson/eco">Eco</a> are all fine alternatives.
    ...
    <p>
      ...
      use <a href="https://documentcloud.github.com/jammit/">Jammit</a> in order
...
<pre>Backbone.$ = require('jquery');
    ...
    <ul>
      ...
      <li>
        ...
        <a href="https://mustache.github.com">way</a>.
      </li>
      <li>
      ...
      <li>
        Backbone scales well, from <a href="https://disqus.com">embedded widgets</a>
        to <a href="https://www.usatoday.com">massive apps</a>.
      </li>
      <li>
      ...
      <li>
        ...
        <a href="https://nytimes.github.com/backbone.stickit/">for it</a>.
      </li>
      <li>
...
<pre>  {
    ...
    <p>
      ...
      <a href="https://jqueryui.com/">jQuery UI</a> in your <tt>render</tt> function.
...
inbox.messages.fetch({reset: true});
    ...
    <p id="FAQ-bootstrap">
      ...
      <a href="https://en.wikipedia.org/wiki/ERuby">ERB</a> template for the
...
&lt;/script&gt;
    ...
    <p>You have to <a href="https://mathiasbynens.be/notes/etago">escape</a>
...
Inbox.messages.add(newMessage);
    ...
    <p id="FAQ-rails">
      ...
      <a href="https://www.documentcloud.org">a Rails application</a>; getting
...
<pre>ActiveRecord::Base.include_root_in_json = false
    ...
    <p id="examples-todos">
      ...
      <a href="https://github.com/jeromegn/Backbone.localStorage">LocalStorage adapter</a>
    ...
    <p>
      The <a href="https://www.documentcloud.org/public/#search/">DocumentCloud workspace</a>
    ...
    <div style="text-align: center;">
      <a href="https://www.documentcloud.org/public/#search/">
    ...
    <p>
      <a href="https://usatoday.com">USA Today</a> takes advantage of the modularity of
    ...
    <p>
      <a href="https://earth.nullschool.net">Earth.nullschool.net</a> displays real-time weather
    ...
    <p>
      ...
      <a href="https://www.polygon.com/">Polygon</a>,
      <a href="https://www.eater.com/">Eater</a>,
      <a href="https://www.racked.com/">Racked</a>,
      <a href="http://www.curbed.com/">Curbed</a>, and
      <a href="https://www.vox.com/">Vox.com</a>, uses Backbone throughout
      ...
      <a href="https://product.voxmedia.com/post/25113965826/introducing-syllabus-vox-medias-s3-powered-liveblog">liveblogging platform</a>
      and <a href="https://product.voxmedia.com/2013/11/11/5426878/using-backbone-js-for-sanity-and-stability">commenting system</a>
      ...
      <a href="https://www.vox.com/cards/ukraine-everything-you-need-to-know/what-is-the-ukraine-crisis">Vox Cards</a>,
    ...
    <p>
      <a href="https://kinja.com">Kinja</a> is Gawker Media's publishing platform designed
    ...
    <p>
      ...
      <a href="https://gizmodo.com/">Gizmodo</a>,
      <a href="https://lifehacker.com/">Lifehacker</a>,
      <a href="https://io9.gizmodo.com/">io9</a> and other Gawker Media
      ...
      <a href="https://jquery.com/">jQuery</a>, with some plugins,
      all loaded with
      <a href="http://requirejs.org/">RequireJS</a>. Closure templates are shared between the
      <a href="https://www.playframework.com/">Play! Framework</a> based Scala application and Backbone views, and the responsive layout
      is done with the
    ...
    <p>
      <a href="https://www.newsblur.com">NewsBlur</a> is an RSS feed reader and
      ...
      <a href="https://github.com/samuelclay/NewsBlur">open-source</a>.
    </p>

    <div style="text-align: center;">
      <a href="https://newsblur.com">
    ...
    <p>
      <a href="https://wordpress.com/">WordPress.com</a> is the software-as-a-service
      version of <a href="https://wordpress.org">WordPress</a>. It uses Backbone.js
      Models, Collections, and Views in its
      <a href="https://en.blog.wordpress.com/2012/05/25/notifications-refreshed/">Notifications system</a>.  Backbone.js was selected
      because it was easy to fit into the structure of the application, not the
      other way around. <a href="https://automattic.com">Automattic</a>
    ...
    <p>
      <a href="https://www.bitbucket.org">Bitbucket</a> is a free source code hosting
    ...
    <div style="text-align: center;">
      <a href="https://www.bitbucket.org">
    ...
    <p>
      <a href="https://www.disqus.com">Disqus</a> chose Backbone.js to power the
    ...
    <p>
      <a href="https://www.khanacademy.org">Khan Academy</a> is on a mission to
    ...
    <p>
      <a href="https://irccloud.com/">IRCCloud</a>
    ...
    <p>
      <a href="https://www.walmart.com/">Walmart</a> used Backbone.js to create the new version
      of <a href="http://mobile.walmart.com/">their mobile web application</a> and
      created two new frameworks in the process.
      <a href="https://walmartlabs.github.com/thorax/">Thorax</a> provides mixins, inheritable
      ...
      <a href="https://walmartlabs.github.com/lumbar/">Lumbar</a> allows the application to be
    ...
    <p>
      <a href="https://www.groupon.com/now">Groupon Now!</a> helps you find
    ...
    <div style="text-align: center;">
      <a href="https://www.groupon.com/now">
    ...
    <p>
      <a href="https://37signals.com/">37Signals</a> chose Backbone.js to create
      the <a href="https://basecamp.com/calendar">calendar feature</a> of its
      popular project management software <a href="https://basecamp.com/">Basecamp</a>.
    ...
    <div style="text-align: center;">
      <a href="https://basecamp.com/calendar">
    ...
    <p>
      <a href="https://slaveryfootprint.org/survey">Slavery Footprint</a>
    ...
    <div style="text-align: center;">
      <a href="https://slaveryfootprint.org/survey">
    ...
    <p>
      <a href="https://airbnb.com">Airbnb</a> uses Backbone in many of its products.
      It started with <a href="https://m.airbnb.com">Airbnb Mobile Web</a>
      (built in six weeks by a team of three) and has since grown to
      <a href="https://www.airbnb.com/wishlists/popular">Wish Lists</a>,
      <a href="https://www.airbnb.com/match">Match</a>,
      <a href="https://www.airbnb.com/s/">Search</a>, Communities, Payments, and
      Internal Tools.
    </p>

    <div style="text-align: center;">
      <a href="https://m.airbnb.com/">
    ...
    <p>
      <a href="https://soundcloud.com">SoundCloud</a> is the leading sound sharing
      platform on the internet, and Backbone.js provides the foundation for
      <a href="https://m.soundcloud.com">SoundCloud Mobile</a>. The project uses
      the public SoundCloud <a href="https://soundcloud.com/developers">API</a>
    ...
    <p>
      <a href="https://artsy.net">Art.sy</a> is a place to discover art you'll
      love. Art.sy is built on Rails, using
      <a href="https://github.com/intridea/grape">Grape</a> to serve a robust
      <a href="https://artsy.net/api">JSON API</a>. The main site is a single page
    ...
    <p>
      When <a href="https://www.pandora.com/newpandora">Pandora</a> redesigned
    ...
    <div style="text-align: center;">
      <a href="https://www.pandora.com/newpandora">
    ...
    <p>
      <a href="https://www.codeschool.com">Code School</a> courses teach people
      ...
      event handling. Before, the page was a mess of <a href="https://jquery.com/">jQuery</a> DOM manipulation
    ...
    <p>
      ...
      <a href="https://pusher.com">Pusher</a> and fed to
      <a href="https://github.com/janl/mustache.js">Mustache</a> templates for
      rendering. Check out the <a href="https://cloudapp.github.com/engine">annotated source code</a>
      to see the magic.
    </p>
    ...
    <p>
      <a href="https://seatgeek.com">SeatGeek</a>'s stadium ticket maps were originally
      developed with <a href="http://prototypejs.org/">Prototype.js</a>. Moving to Backbone.js and <a href="https://jquery.com/">jQuery</a> helped organize
    ...
    <p>
      <a href="https://www.jolicloud.com/">Jolicloud</a> is an open and independent
      platform and <a href="https://www.jolicloud.com/jolios">operating system</a>
      ...
      with the <a href="https://www.jolicloud.com/jolios">Joli OS</a> via WebSockets.
    </p>

    <div style="text-align: center;">
      <a href="https://jolicloud.com/">
    ...
    <p>
      <a href="https://salon.io">Salon.io</a> provides a space where photographers,
      artists and designers freely arrange their visual art on virtual walls.
      <a href="https://salon.io">Salon.io</a> runs on <a href="http://rubyonrails.org/">Rails</a>, but does not use
    ...
    <p>
      Our fellow
      <a href="https://www.newschallenge.org/">Knight Foundation News Challenge</a>
      winners, <a href="https://mapbox.com/">MapBox</a>, created an open-source
      ...
      Note that the gorgeous <a href="https://mapbox.com/">MapBox</a> homepage
    ...
    <p>
      <a href="https://blossom.io">Blossom</a> is a lightweight project management
    ...
    <p>
      <a href="https://trello.com">Trello</a> is a collaboration tool that
    ...
    <p>
      <a href="https://twitter.com/evilchelu">Cristi Balan</a> and
      ...
      <a href="https://documentcloud.github.com/jammit/">Jammit</a>
    ...
    <p>
      ...
      Backbone is now published as an <a href="https://npmjs.org">NPM</a> module.
    </p>
    ...
    <p>
      ...
      <a href="https://documentcloud.org/" title="A DocumentCloud Project" style="background:none;">
        <img src="https://jashkenas.s3.amazonaws.com/images/a_documentcloud_project.png" alt="A DocumentCloud Project" style="position:relative;left:-10px;" />
      </a>
    </p>
